...
weights={
    ...
    'd3conv332': tf.get_variable('d3conv332w',[3,3,96,24],tf.float32,initializer),
    'd3conv341': tf.get_variable('d3conv341w',[1,1,978,96],tf.float32,initializer),
    'd3conv342': tf.get_variable('d3conv342w',[3,3,96,24],tf.float32,initializer),
    'd3conv351': tf.get_variable('d3conv351w',[1,1,1002,96],tf.float32,initializer),
    'd3conv352': tf.get_variable('d3conv352w',[3,3,96,24],tf.float32,initializer),
    'd3conv361': tf.get_variable('d3conv361w',[1,1,1026,96],tf.float32,initializer),
    'd3conv362': tf.get_variable('d3conv362w',[3,3,96,24],tf.float32,initializer),
    'd3conv371': tf.get_variable('d3conv371w',[1,1,1050,96],tf.float32,initializer),
    'd3conv372': tf.get_variable('d3conv372w',[3,3,96,24],tf.float32,initializer),
    'd3conv381': tf.get_variable('d3conv381w',[1,1,1074,96],tf.float32,initializer),
    'd3conv382': tf.get_variable('d3conv382w',[3,3,96,24],tf.float32,initializer),
    'd3conv391': tf.get_variable('d3conv391w',[1,1,1098,96],tf.float32,initializer),
    'd3conv392': tf.get_variable('d3conv392w',[3,3,96,24],tf.float32,initializer),
    'd3conv401': tf.get_variable('d3conv401w',[1,1,1122,96],tf.float32,initializer),
    'd3conv402': tf.get_variable('d3conv402w',[3,3,96,24],tf.float32,initializer),
    'd3conv411': tf.get_variable('d3conv411w',[1,1,1146,96],tf.float32,initializer),
    'd3conv412': tf.get_variable('d3conv412w',[3,3,96,24],tf.float32,initializer),
    'd3conv421': tf.get_variable('d3conv421w',[1,1,1170,96],tf.float32,initializer),
    'd3conv422': tf.get_variable('d3conv422w',[3,3,96,24],tf.float32,initializer),
    'd3conv431': tf.get_variable('d3conv431w',[1,1,1194,96],tf.float32,initializer),
    'd3conv432': tf.get_variable('d3conv432w',[3,3,96,24],tf.float32,initializer),
    'd3conv441': tf.get_variable('d3conv441w',[1,1,1218,96],tf.float32,initializer),
    'd3conv442': tf.get_variable('d3conv442w',[3,3,96,24],tf.float32,initializer),
    'd3conv451': tf.get_variable('d3conv451w',[1,1,1242,96],tf.float32,initializer),
    'd3conv452': tf.get_variable('d3conv452w',[3,3,96,24],tf.float32,initializer),
    'd3conv461': tf.get_variable('d3conv461w',[1,1,1266,96],tf.float32,initializer),
    'd3conv462': tf.get_variable('d3conv462w',[3,3,96,24],tf.float32,initializer),
    'd3conv471': tf.get_variable('d3conv471w',[1,1,1290,96],tf.float32,initializer),
    'd3conv472': tf.get_variable('d3conv472w',[3,3,96,24],tf.float32,initializer),
    'd3conv481': tf.get_variable('d3conv481w',[1,1,1314,96],tf.float32,initializer),
    'd3conv482': tf.get_variable('d3conv482w',[3,3,96,24],tf.float32,initializer),
    'd3conv491': tf.get_variable('d3conv491w',[1,1,1338,96],tf.float32,initializer),
    'd3conv492': tf.get_variable('d3conv492w',[3,3,96,24],tf.float32,initializer),
    'd3conv501': tf.get_variable('d3conv501w',[1,1,1362,96],tf.float32,initializer),
    'd3conv502': tf.get_variable('d3conv502w',[3,3,96,24],tf.float32,initializer),
    'd3conv511': tf.get_variable('d3conv511w',[1,1,1386,96],tf.float32,initializer),
    'd3conv512': tf.get_variable('d3conv512w',[3,3,96,24],tf.float32,initializer),
    'd3conv521': tf.get_variable('d3conv521w',[1,1,1410,96],tf.float32,initializer),
    'd3conv522': tf.get_variable('d3conv522w',[3,3,96,24],tf.float32,initializer),
    'd3conv531': tf.get_variable('d3conv531w',[1,1,1434,96],tf.float32,initializer),
    'd3conv532': tf.get_variable('d3conv532w',[3,3,96,24],tf.float32,initializer),
    'd3conv541': tf.get_variable('d3conv541w',[1,1,1458,96],tf.float32,initializer),
    'd3conv542': tf.get_variable('d3conv542w',[3,3,96,24],tf.float32,initializer),
    'd3conv551': tf.get_variable('d3conv551w',[1,1,1482,96],tf.float32,initializer),
    'd3conv552': tf.get_variable('d3conv552w',[3,3,96,24],tf.float32,initializer),
    'd3conv561': tf.get_variable('d3conv561w',[1,1,1506,96],tf.float32,initializer),
    'd3conv562': tf.get_variable('d3conv562w',[3,3,96,24],tf.float32,initializer),
    'd3conv571': tf.get_variable('d3conv571w',[1,1,1530,96],tf.float32,initializer),
    'd3conv572': tf.get_variable('d3conv572w',[3,3,96,24],tf.float32,initializer),
    'd3conv581': tf.get_variable('d3conv581w',[1,1,1554,96],tf.float32,initializer),
    'd3conv582': tf.get_variable('d3conv582w',[3,3,96,24],tf.float32,initializer),
    'd3conv591': tf.get_variable('d3conv591w',[1,1,1578,96],tf.float32,initializer),
    'd3conv592': tf.get_variable('d3conv592w',[3,3,96,24],tf.float32,initializer),
    'd3conv601': tf.get_variable('d3conv601w',[1,1,1602,96],tf.float32,initializer),
    'd3conv602': tf.get_variable('d3conv602w',[3,3,96,24],tf.float32,initializer),
    ...
    'd4conv332': tf.get_variable('d4conv332w',[3,3,96,24],tf.float32,initializer),
    'd4conv341': tf.get_variable('d4conv341w',[1,1,1605,96],tf.float32,initializer),
    'd4conv342': tf.get_variable('d4conv342w',[3,3,96,24],tf.float32,initializer),
    'd4conv351': tf.get_variable('d4conv351w',[1,1,1629,96],tf.float32,initializer),
    'd4conv352': tf.get_variable('d4conv352w',[3,3,96,24],tf.float32,initializer),
    'd4conv361': tf.get_variable('d4conv361w',[1,1,1653,96],tf.float32,initializer),
    'd4conv362': tf.get_variable('d4conv362w',[3,3,96,24],tf.float32,initializer),
    'd4conv371': tf.get_variable('d4conv371w',[1,1,1677,96],tf.float32,initializer),
    'd4conv372': tf.get_variable('d4conv372w',[3,3,96,24],tf.float32,initializer),
    'd4conv381': tf.get_variable('d4conv381w',[1,1,1701,96],tf.float32,initializer),
    'd4conv382': tf.get_variable('d4conv382w',[3,3,96,24],tf.float32,initializer),
    'd4conv391': tf.get_variable('d4conv391w',[1,1,1725,96],tf.float32,initializer),
    'd4conv392': tf.get_variable('d4conv392w',[3,3,96,24],tf.float32,initializer),
    'd4conv401': tf.get_variable('d4conv401w',[1,1,1749,96],tf.float32,initializer),
    'd4conv402': tf.get_variable('d4conv402w',[3,3,96,24],tf.float32,initializer),
    'd4conv411': tf.get_variable('d4conv411w',[1,1,1773,96],tf.float32,initializer),
    'd4conv412': tf.get_variable('d4conv412w',[3,3,96,24],tf.float32,initializer),
    'd4conv421': tf.get_variable('d4conv421w',[1,1,1797,96],tf.float32,initializer),
    'd4conv422': tf.get_variable('d4conv422w',[3,3,96,24],tf.float32,initializer),
...
biases={
    ...
    'd3conv332': tf.get_variable('d3conv332b',[24],tf.float32,initializer),
    'd3conv341': tf.get_variable('d3conv341b',[96],tf.float32,initializer),
    'd3conv342': tf.get_variable('d3conv342b',[24],tf.float32,initializer),
    'd3conv351': tf.get_variable('d3conv351b',[96],tf.float32,initializer),
    'd3conv352': tf.get_variable('d3conv352b',[24],tf.float32,initializer),
    'd3conv361': tf.get_variable('d3conv361b',[96],tf.float32,initializer),
    'd3conv362': tf.get_variable('d3conv362b',[24],tf.float32,initializer),
    'd3conv371': tf.get_variable('d3conv371b',[96],tf.float32,initializer),
    'd3conv372': tf.get_variable('d3conv372b',[24],tf.float32,initializer),
    'd3conv381': tf.get_variable('d3conv381b',[96],tf.float32,initializer),
    'd3conv382': tf.get_variable('d3conv382b',[24],tf.float32,initializer),
    'd3conv391': tf.get_variable('d3conv391b',[96],tf.float32,initializer),
    'd3conv392': tf.get_variable('d3conv392b',[24],tf.float32,initializer),
    'd3conv401': tf.get_variable('d3conv401b',[96],tf.float32,initializer),
    'd3conv402': tf.get_variable('d3conv402b',[24],tf.float32,initializer),
    'd3conv411': tf.get_variable('d3conv411b',[96],tf.float32,initializer),
    'd3conv412': tf.get_variable('d3conv412b',[24],tf.float32,initializer),
    'd3conv421': tf.get_variable('d3conv421b',[96],tf.float32,initializer),
    'd3conv422': tf.get_variable('d3conv422b',[24],tf.float32,initializer),
    'd3conv431': tf.get_variable('d3conv431b',[96],tf.float32,initializer),
    'd3conv432': tf.get_variable('d3conv432b',[24],tf.float32,initializer),
    'd3conv441': tf.get_variable('d3conv441b',[96],tf.float32,initializer),
    'd3conv442': tf.get_variable('d3conv442b',[24],tf.float32,initializer),
    'd3conv451': tf.get_variable('d3conv451b',[96],tf.float32,initializer),
    'd3conv452': tf.get_variable('d3conv452b',[24],tf.float32,initializer),
    'd3conv461': tf.get_variable('d3conv461b',[96],tf.float32,initializer),
    'd3conv462': tf.get_variable('d3conv462b',[24],tf.float32,initializer),
    'd3conv471': tf.get_variable('d3conv471b',[96],tf.float32,initializer),
    'd3conv472': tf.get_variable('d3conv472b',[24],tf.float32,initializer),
    'd3conv481': tf.get_variable('d3conv481b',[96],tf.float32,initializer),
    'd3conv482': tf.get_variable('d3conv482b',[24],tf.float32,initializer),
    'd3conv491': tf.get_variable('d3conv491b',[96],tf.float32,initializer),
    'd3conv492': tf.get_variable('d3conv492b',[24],tf.float32,initializer),
    'd3conv501': tf.get_variable('d3conv501b',[96],tf.float32,initializer),
    'd3conv502': tf.get_variable('d3conv502b',[24],tf.float32,initializer),
    'd3conv511': tf.get_variable('d3conv511b',[96],tf.float32,initializer),
    'd3conv512': tf.get_variable('d3conv512b',[24],tf.float32,initializer),
    'd3conv521': tf.get_variable('d3conv521b',[96],tf.float32,initializer),
    'd3conv522': tf.get_variable('d3conv522b',[24],tf.float32,initializer),
    'd3conv531': tf.get_variable('d3conv531b',[96],tf.float32,initializer),
    'd3conv532': tf.get_variable('d3conv532b',[24],tf.float32,initializer),
    'd3conv541': tf.get_variable('d3conv541b',[96],tf.float32,initializer),
    'd3conv542': tf.get_variable('d3conv542b',[24],tf.float32,initializer),
    'd3conv551': tf.get_variable('d3conv551b',[96],tf.float32,initializer),
    'd3conv552': tf.get_variable('d3conv552b',[24],tf.float32,initializer),
    'd3conv561': tf.get_variable('d3conv561b',[96],tf.float32,initializer),
    'd3conv562': tf.get_variable('d3conv562b',[24],tf.float32,initializer),
    'd3conv571': tf.get_variable('d3conv571b',[96],tf.float32,initializer),
    'd3conv572': tf.get_variable('d3conv572b',[24],tf.float32,initializer),
    'd3conv581': tf.get_variable('d3conv581b',[96],tf.float32,initializer),
    'd3conv582': tf.get_variable('d3conv582b',[24],tf.float32,initializer),
    'd3conv591': tf.get_variable('d3conv591b',[96],tf.float32,initializer),
    'd3conv592': tf.get_variable('d3conv592b',[24],tf.float32,initializer),
    'd3conv601': tf.get_variable('d3conv601b',[96],tf.float32,initializer),
    'd3conv602': tf.get_variable('d3conv602b',[24],tf.float32,initializer),
    ...
    'd4conv332': tf.get_variable('d4conv332b',[24],tf.float32,initializer),
    'd4conv341': tf.get_variable('d4conv341b',[96],tf.float32,initializer),
    'd4conv342': tf.get_variable('d4conv342b',[24],tf.float32,initializer),
    'd4conv351': tf.get_variable('d4conv351b',[96],tf.float32,initializer),
    'd4conv352': tf.get_variable('d4conv352b',[24],tf.float32,initializer),
    'd4conv361': tf.get_variable('d4conv361b',[96],tf.float32,initializer),
    'd4conv362': tf.get_variable('d4conv362b',[24],tf.float32,initializer),
    'd4conv371': tf.get_variable('d4conv371b',[96],tf.float32,initializer),
    'd4conv372': tf.get_variable('d4conv372b',[24],tf.float32,initializer),
    'd4conv381': tf.get_variable('d4conv381b',[96],tf.float32,initializer),
    'd4conv382': tf.get_variable('d4conv382b',[24],tf.float32,initializer),
    'd4conv391': tf.get_variable('d4conv391b',[96],tf.float32,initializer),
    'd4conv392': tf.get_variable('d4conv392b',[24],tf.float32,initializer),
    'd4conv401': tf.get_variable('d4conv401b',[96],tf.float32,initializer),
    'd4conv402': tf.get_variable('d4conv402b',[24],tf.float32,initializer),
    'd4conv411': tf.get_variable('d4conv411b',[96],tf.float32,initializer),
    'd4conv412': tf.get_variable('d4conv412b',[24],tf.float32,initializer),
    'd4conv421': tf.get_variable('d4conv421b',[96],tf.float32,initializer),
    'd4conv422': tf.get_variable('d4conv422b',[24],tf.float32,initializer),
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-250-24/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-250-24/var.ckpt',sess)
