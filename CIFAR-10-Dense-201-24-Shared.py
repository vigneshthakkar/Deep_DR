...
weights={
    ...
    'd333conv2': tf.get_variable('d3conv252w',[3,3,96,24],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv172w',[3,3,96,24],tf.float32,initializer),
...
biases={
    ...
    'd333conv2': tf.get_variable('d3conv252b',[24],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv172b',[24],tf.float32,initializer),
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-201-24-Shared/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-201-24-Shared/var.ckpt',sess)
