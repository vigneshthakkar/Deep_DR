...
weights={
    ...
    't3conv': tf.get_variable('t3convw',[1,1,261,130],tf.float32,initializer),

    'd4conv11': tf.get_variable('d4conv11w',[1,1,130,48],tf.float32,initializer),
    'd4conv12': tf.get_variable('d4conv12w',[3,3,48,12],tf.float32,initializer),
    'd4conv21': tf.get_variable('d4conv21w',[1,1,142,48],tf.float32,initializer),
    'd4conv22': tf.get_variable('d4conv22w',[3,3,48,12],tf.float32,initializer),
    'd4conv31': tf.get_variable('d4conv31w',[1,1,154,48],tf.float32,initializer),
    'd4conv32': tf.get_variable('d4conv32w',[3,3,48,12],tf.float32,initializer),
    'd4conv41': tf.get_variable('d4conv41w',[1,1,166,48],tf.float32,initializer),
    'd4conv42': tf.get_variable('d4conv42w',[3,3,48,12],tf.float32,initializer),
    'd4conv51': tf.get_variable('d4conv51w',[1,1,178,48],tf.float32,initializer),
    'd4conv52': tf.get_variable('d4conv52w',[3,3,48,12],tf.float32,initializer),
    'd4conv61': tf.get_variable('d4conv61w',[1,1,190,48],tf.float32,initializer),
    'd4conv62': tf.get_variable('d4conv62w',[3,3,48,12],tf.float32,initializer),
    'd4conv71': tf.get_variable('d4conv71w',[1,1,202,48],tf.float32,initializer),
    'd4conv72': tf.get_variable('d4conv72w',[3,3,48,12],tf.float32,initializer),
    'd4conv81': tf.get_variable('d4conv81w',[1,1,214,48],tf.float32,initializer),
    'd4conv82': tf.get_variable('d4conv82w',[3,3,48,12],tf.float32,initializer),
    'd4conv91': tf.get_variable('d4conv91w',[1,1,226,48],tf.float32,initializer),
    'd4conv92': tf.get_variable('d4conv92w',[3,3,48,12],tf.float32,initializer),
    'd4conv101': tf.get_variable('d4conv101w',[1,1,238,48],tf.float32,initializer),
    'd4conv102': tf.get_variable('d4conv102w',[3,3,48,12],tf.float32,initializer),
    'd4conv111': tf.get_variable('d4conv111w',[1,1,250,48],tf.float32,initializer),
    'd4conv112': tf.get_variable('d4conv112w',[3,3,48,12],tf.float32,initializer),
    'd4conv121': tf.get_variable('d4conv121w',[1,1,262,48],tf.float32,initializer),
    'd4conv122': tf.get_variable('d4conv122w',[3,3,48,12],tf.float32,initializer),
    'd4conv131': tf.get_variable('d4conv131w',[1,1,274,48],tf.float32,initializer),
    'd4conv132': tf.get_variable('d4conv132w',[3,3,48,12],tf.float32,initializer),
    'd4conv141': tf.get_variable('d4conv141w',[1,1,286,48],tf.float32,initializer),
    'd4conv142': tf.get_variable('d4conv142w',[3,3,48,12],tf.float32,initializer),

    'fc': tf.get_variable('fcw',[298,10],tf.float32,initializer),
}
...
biases={
    ...
    't3conv': tf.get_variable('t3conv',[130],tf.float32,initializer),
...
def classification(x,weightfc,biasfc):
    globalpool=tf.reshape(tf.nn.avg_pool(x,ksize=[1,4,4,1],strides=[1,1,1,1],padding='VALID'),[-1,298])
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-102-12/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-102-12/var.ckpt',sess)
