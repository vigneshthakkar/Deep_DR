...
weights={
    ...
    't3conv': tf.get_variable('t3convw',[1,1,1338,669],tf.float32,initializer),

    'd4conv11': tf.get_variable('d4conv11w',[1,1,669,96],tf.float32,initializer),
    'd4conv12': tf.get_variable('d4conv12w',[3,3,96,24],tf.float32,initializer),
    'd4conv21': tf.get_variable('d4conv21w',[1,1,693,96],tf.float32,initializer),
    'd4conv22': tf.get_variable('d4conv22w',[3,3,96,24],tf.float32,initializer),
    'd4conv31': tf.get_variable('d4conv31w',[1,1,717,96],tf.float32,initializer),
    'd4conv32': tf.get_variable('d4conv32w',[3,3,96,24],tf.float32,initializer),
    'd4conv41': tf.get_variable('d4conv41w',[1,1,741,96],tf.float32,initializer),
    'd4conv42': tf.get_variable('d4conv42w',[3,3,96,24],tf.float32,initializer),
    'd4conv51': tf.get_variable('d4conv51w',[1,1,765,96],tf.float32,initializer),
    'd4conv52': tf.get_variable('d4conv52w',[3,3,96,24],tf.float32,initializer),
    'd4conv61': tf.get_variable('d4conv61w',[1,1,789,96],tf.float32,initializer),
    'd4conv62': tf.get_variable('d4conv62w',[3,3,96,24],tf.float32,initializer),
    'd4conv71': tf.get_variable('d4conv71w',[1,1,813,96],tf.float32,initializer),
    'd4conv72': tf.get_variable('d4conv72w',[3,3,96,24],tf.float32,initializer),
    'd4conv81': tf.get_variable('d4conv81w',[1,1,837,96],tf.float32,initializer),
    'd4conv82': tf.get_variable('d4conv82w',[3,3,96,24],tf.float32,initializer),
    'd4conv91': tf.get_variable('d4conv91w',[1,1,861,96],tf.float32,initializer),
    'd4conv92': tf.get_variable('d4conv92w',[3,3,96,24],tf.float32,initializer),
    'd4conv101': tf.get_variable('d4conv101w',[1,1,885,96],tf.float32,initializer),
    'd4conv102': tf.get_variable('d4conv102w',[3,3,96,24],tf.float32,initializer),
    'd4conv111': tf.get_variable('d4conv111w',[1,1,909,96],tf.float32,initializer),
    'd4conv112': tf.get_variable('d4conv112w',[3,3,96,24],tf.float32,initializer),
    'd4conv121': tf.get_variable('d4conv121w',[1,1,933,96],tf.float32,initializer),
    'd4conv122': tf.get_variable('d4conv122w',[3,3,96,24],tf.float32,initializer),
    'd4conv131': tf.get_variable('d4conv131w',[1,1,957,96],tf.float32,initializer),
    'd4conv132': tf.get_variable('d4conv132w',[3,3,96,24],tf.float32,initializer),
    'd4conv141': tf.get_variable('d4conv141w',[1,1,981,96],tf.float32,initializer),
    'd4conv142': tf.get_variable('d4conv142w',[3,3,96,24],tf.float32,initializer),
    'd4conv151': tf.get_variable('d4conv151w',[1,1,1005,96],tf.float32,initializer),
    'd4conv152': tf.get_variable('d4conv152w',[3,3,96,24],tf.float32,initializer),
    'd4conv161': tf.get_variable('d4conv161w',[1,1,1029,96],tf.float32,initializer),
    'd4conv162': tf.get_variable('d4conv162w',[3,3,96,24],tf.float32,initializer),
    'd4conv171': tf.get_variable('d4conv171w',[1,1,1053,96],tf.float32,initializer),
    'd4conv172': tf.get_variable('d4conv172w',[3,3,96,24],tf.float32,initializer),
    'd4conv181': tf.get_variable('d4conv181w',[1,1,1077,96],tf.float32,initializer),
    'd4conv182': tf.get_variable('d4conv182w',[3,3,96,24],tf.float32,initializer),
    'd4conv191': tf.get_variable('d4conv191w',[1,1,1101,96],tf.float32,initializer),
    'd4conv192': tf.get_variable('d4conv192w',[3,3,96,24],tf.float32,initializer),
    'd4conv201': tf.get_variable('d4conv201w',[1,1,1125,96],tf.float32,initializer),
    'd4conv202': tf.get_variable('d4conv202w',[3,3,96,24],tf.float32,initializer),
    'd4conv211': tf.get_variable('d4conv211w',[1,1,1149,96],tf.float32,initializer),
    'd4conv212': tf.get_variable('d4conv212w',[3,3,96,24],tf.float32,initializer),
    'd4conv221': tf.get_variable('d4conv221w',[1,1,1173,96],tf.float32,initializer),
    'd4conv222': tf.get_variable('d4conv222w',[3,3,96,24],tf.float32,initializer),
    'd4conv231': tf.get_variable('d4conv231w',[1,1,1197,96],tf.float32,initializer),
    'd4conv232': tf.get_variable('d4conv232w',[3,3,96,24],tf.float32,initializer),
    'd4conv241': tf.get_variable('d4conv241w',[1,1,1221,96],tf.float32,initializer),
    'd4conv242': tf.get_variable('d4conv242w',[3,3,96,24],tf.float32,initializer),
    'd4conv251': tf.get_variable('d4conv251w',[1,1,1245,96],tf.float32,initializer),
    'd4conv252': tf.get_variable('d4conv252w',[3,3,96,24],tf.float32,initializer),
    'd4conv261': tf.get_variable('d4conv261w',[1,1,1269,96],tf.float32,initializer),
    'd4conv262': tf.get_variable('d4conv262w',[3,3,96,24],tf.float32,initializer),
    'd4conv271': tf.get_variable('d4conv271w',[1,1,1293,96],tf.float32,initializer),
    'd4conv272': tf.get_variable('d4conv272w',[3,3,96,24],tf.float32,initializer),
    'd4conv281': tf.get_variable('d4conv281w',[1,1,1317,96],tf.float32,initializer),
    'd4conv282': tf.get_variable('d4conv282w',[3,3,96,24],tf.float32,initializer),
    'd4conv291': tf.get_variable('d4conv291w',[1,1,1341,96],tf.float32,initializer),
    'd4conv292': tf.get_variable('d4conv292w',[3,3,96,24],tf.float32,initializer),
    'd4conv301': tf.get_variable('d4conv301w',[1,1,1365,96],tf.float32,initializer),
    'd4conv302': tf.get_variable('d4conv302w',[3,3,96,24],tf.float32,initializer),
    'd4conv311': tf.get_variable('d4conv311w',[1,1,1389,96],tf.float32,initializer),
    'd4conv312': tf.get_variable('d4conv312w',[3,3,96,24],tf.float32,initializer),
    'd4conv321': tf.get_variable('d4conv321w',[1,1,1413,96],tf.float32,initializer),
    'd4conv322': tf.get_variable('d4conv322w',[3,3,96,24],tf.float32,initializer),

    'fc': tf.get_variable('fcw',[1437,10],tf.float32,initializer),
}
...
biases={
    ...
    't3conv': tf.get_variable('t3conv',[669],tf.float32,initializer),
...
def classification(x,weightfc,biasfc):
    globalpool=tf.reshape(tf.nn.avg_pool(x,ksize=[1,4,4,1],strides=[1,1,1,1],padding='VALID'),[-1,1437])
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-201-24/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-201-24/var.ckpt',sess)
