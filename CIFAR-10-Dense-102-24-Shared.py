...
weights={
    ...
    'd333conv2': tf.get_variable('d3conv82w',[3,3,96,24],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv82w',[3,3,96,24],tf.float32,initializer),
...
biases={
    ...
    'd333conv2': tf.get_variable('d3conv82b',[24],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv82b',[24],tf.float32,initializer),
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-102-24-Shared/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-102-24-Shared/var.ckpt',sess)
