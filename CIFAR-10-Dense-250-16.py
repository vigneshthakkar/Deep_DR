...
weights={
    ...
    'd3conv332': tf.get_variable('d3conv332w',[3,3,64,16],tf.float32,initializer),
    'd3conv341': tf.get_variable('d3conv341w',[1,1,652,64],tf.float32,initializer),
    'd3conv342': tf.get_variable('d3conv342w',[3,3,64,16],tf.float32,initializer),
    'd3conv351': tf.get_variable('d3conv351w',[1,1,668,64],tf.float32,initializer),
    'd3conv352': tf.get_variable('d3conv352w',[3,3,64,16],tf.float32,initializer),
    'd3conv361': tf.get_variable('d3conv361w',[1,1,684,64],tf.float32,initializer),
    'd3conv362': tf.get_variable('d3conv362w',[3,3,64,16],tf.float32,initializer),
    'd3conv371': tf.get_variable('d3conv371w',[1,1,700,64],tf.float32,initializer),
    'd3conv372': tf.get_variable('d3conv372w',[3,3,64,16],tf.float32,initializer),
    'd3conv381': tf.get_variable('d3conv381w',[1,1,716,64],tf.float32,initializer),
    'd3conv382': tf.get_variable('d3conv382w',[3,3,64,16],tf.float32,initializer),
    'd3conv391': tf.get_variable('d3conv391w',[1,1,732,64],tf.float32,initializer),
    'd3conv392': tf.get_variable('d3conv392w',[3,3,64,16],tf.float32,initializer),
    'd3conv401': tf.get_variable('d3conv401w',[1,1,748,64],tf.float32,initializer),
    'd3conv402': tf.get_variable('d3conv402w',[3,3,64,16],tf.float32,initializer),
    'd3conv411': tf.get_variable('d3conv411w',[1,1,764,64],tf.float32,initializer),
    'd3conv412': tf.get_variable('d3conv412w',[3,3,64,16],tf.float32,initializer),
    'd3conv421': tf.get_variable('d3conv421w',[1,1,780,64],tf.float32,initializer),
    'd3conv422': tf.get_variable('d3conv422w',[3,3,64,16],tf.float32,initializer),
    'd3conv431': tf.get_variable('d3conv431w',[1,1,796,64],tf.float32,initializer),
    'd3conv432': tf.get_variable('d3conv432w',[3,3,64,16],tf.float32,initializer),
    'd3conv441': tf.get_variable('d3conv441w',[1,1,812,64],tf.float32,initializer),
    'd3conv442': tf.get_variable('d3conv442w',[3,3,64,16],tf.float32,initializer),
    'd3conv451': tf.get_variable('d3conv451w',[1,1,828,64],tf.float32,initializer),
    'd3conv452': tf.get_variable('d3conv452w',[3,3,64,16],tf.float32,initializer),
    'd3conv461': tf.get_variable('d3conv461w',[1,1,844,64],tf.float32,initializer),
    'd3conv462': tf.get_variable('d3conv462w',[3,3,64,16],tf.float32,initializer),
    'd3conv471': tf.get_variable('d3conv471w',[1,1,860,64],tf.float32,initializer),
    'd3conv472': tf.get_variable('d3conv472w',[3,3,64,16],tf.float32,initializer),
    'd3conv481': tf.get_variable('d3conv481w',[1,1,876,64],tf.float32,initializer),
    'd3conv482': tf.get_variable('d3conv482w',[3,3,64,16],tf.float32,initializer),
    'd3conv491': tf.get_variable('d3conv491w',[1,1,892,64],tf.float32,initializer),
    'd3conv492': tf.get_variable('d3conv492w',[3,3,64,16],tf.float32,initializer),
    'd3conv501': tf.get_variable('d3conv501w',[1,1,908,64],tf.float32,initializer),
    'd3conv502': tf.get_variable('d3conv502w',[3,3,64,16],tf.float32,initializer),
    'd3conv511': tf.get_variable('d3conv511w',[1,1,924,64],tf.float32,initializer),
    'd3conv512': tf.get_variable('d3conv512w',[3,3,64,16],tf.float32,initializer),
    'd3conv521': tf.get_variable('d3conv521w',[1,1,940,64],tf.float32,initializer),
    'd3conv522': tf.get_variable('d3conv522w',[3,3,64,16],tf.float32,initializer),
    'd3conv531': tf.get_variable('d3conv531w',[1,1,956,64],tf.float32,initializer),
    'd3conv532': tf.get_variable('d3conv532w',[3,3,64,16],tf.float32,initializer),
    'd3conv541': tf.get_variable('d3conv541w',[1,1,972,64],tf.float32,initializer),
    'd3conv542': tf.get_variable('d3conv542w',[3,3,64,16],tf.float32,initializer),
    'd3conv551': tf.get_variable('d3conv551w',[1,1,988,64],tf.float32,initializer),
    'd3conv552': tf.get_variable('d3conv552w',[3,3,64,16],tf.float32,initializer),
    'd3conv561': tf.get_variable('d3conv561w',[1,1,1004,64],tf.float32,initializer),
    'd3conv562': tf.get_variable('d3conv562w',[3,3,64,16],tf.float32,initializer),
    'd3conv571': tf.get_variable('d3conv571w',[1,1,1020,64],tf.float32,initializer),
    'd3conv572': tf.get_variable('d3conv572w',[3,3,64,16],tf.float32,initializer),
    'd3conv581': tf.get_variable('d3conv581w',[1,1,1036,64],tf.float32,initializer),
    'd3conv582': tf.get_variable('d3conv582w',[3,3,64,16],tf.float32,initializer),
    'd3conv591': tf.get_variable('d3conv591w',[1,1,1052,64],tf.float32,initializer),
    'd3conv592': tf.get_variable('d3conv592w',[3,3,64,16],tf.float32,initializer),
    'd3conv601': tf.get_variable('d3conv601w',[1,1,1068,64],tf.float32,initializer),
    'd3conv602': tf.get_variable('d3conv602w',[3,3,64,16],tf.float32,initializer),

    't3conv': tf.get_variable('t3convw',[1,1,1084,542],tf.float32,initializer),

    'd4conv11': tf.get_variable('d4conv11w',[1,1,542,64],tf.float32,initializer),
    'd4conv12': tf.get_variable('d4conv12w',[3,3,64,16],tf.float32,initializer),
    'd4conv21': tf.get_variable('d4conv21w',[1,1,558,64],tf.float32,initializer),
    'd4conv22': tf.get_variable('d4conv22w',[3,3,64,16],tf.float32,initializer),
    'd4conv31': tf.get_variable('d4conv31w',[1,1,574,64],tf.float32,initializer),
    'd4conv32': tf.get_variable('d4conv32w',[3,3,64,16],tf.float32,initializer),
    'd4conv41': tf.get_variable('d4conv41w',[1,1,590,64],tf.float32,initializer),
    'd4conv42': tf.get_variable('d4conv42w',[3,3,64,16],tf.float32,initializer),
    'd4conv51': tf.get_variable('d4conv51w',[1,1,606,64],tf.float32,initializer),
    'd4conv52': tf.get_variable('d4conv52w',[3,3,64,16],tf.float32,initializer),
    'd4conv61': tf.get_variable('d4conv61w',[1,1,622,64],tf.float32,initializer),
    'd4conv62': tf.get_variable('d4conv62w',[3,3,64,16],tf.float32,initializer),
    'd4conv71': tf.get_variable('d4conv71w',[1,1,638,64],tf.float32,initializer),
    'd4conv72': tf.get_variable('d4conv72w',[3,3,64,16],tf.float32,initializer),
    'd4conv81': tf.get_variable('d4conv81w',[1,1,654,64],tf.float32,initializer),
    'd4conv82': tf.get_variable('d4conv82w',[3,3,64,16],tf.float32,initializer),
    'd4conv91': tf.get_variable('d4conv91w',[1,1,670,64],tf.float32,initializer),
    'd4conv92': tf.get_variable('d4conv92w',[3,3,64,16],tf.float32,initializer),
    'd4conv101': tf.get_variable('d4conv101w',[1,1,686,64],tf.float32,initializer),
    'd4conv102': tf.get_variable('d4conv102w',[3,3,64,16],tf.float32,initializer),
    'd4conv111': tf.get_variable('d4conv111w',[1,1,702,64],tf.float32,initializer),
    'd4conv112': tf.get_variable('d4conv112w',[3,3,64,16],tf.float32,initializer),
    'd4conv121': tf.get_variable('d4conv121w',[1,1,718,64],tf.float32,initializer),
    'd4conv122': tf.get_variable('d4conv122w',[3,3,64,16],tf.float32,initializer),
    'd4conv131': tf.get_variable('d4conv131w',[1,1,734,64],tf.float32,initializer),
    'd4conv132': tf.get_variable('d4conv132w',[3,3,64,16],tf.float32,initializer),
    'd4conv141': tf.get_variable('d4conv141w',[1,1,750,64],tf.float32,initializer),
    'd4conv142': tf.get_variable('d4conv142w',[3,3,64,16],tf.float32,initializer),
    'd4conv151': tf.get_variable('d4conv151w',[1,1,766,64],tf.float32,initializer),
    'd4conv152': tf.get_variable('d4conv152w',[3,3,64,16],tf.float32,initializer),
    'd4conv161': tf.get_variable('d4conv161w',[1,1,782,64],tf.float32,initializer),
    'd4conv162': tf.get_variable('d4conv162w',[3,3,64,16],tf.float32,initializer),
    'd4conv171': tf.get_variable('d4conv171w',[1,1,798,64],tf.float32,initializer),
    'd4conv172': tf.get_variable('d4conv172w',[3,3,64,16],tf.float32,initializer),
    'd4conv181': tf.get_variable('d4conv181w',[1,1,814,64],tf.float32,initializer),
    'd4conv182': tf.get_variable('d4conv182w',[3,3,64,16],tf.float32,initializer),
    'd4conv191': tf.get_variable('d4conv191w',[1,1,830,64],tf.float32,initializer),
    'd4conv192': tf.get_variable('d4conv192w',[3,3,64,16],tf.float32,initializer),
    'd4conv201': tf.get_variable('d4conv201w',[1,1,846,64],tf.float32,initializer),
    'd4conv202': tf.get_variable('d4conv202w',[3,3,64,16],tf.float32,initializer),
    'd4conv211': tf.get_variable('d4conv211w',[1,1,862,64],tf.float32,initializer),
    'd4conv212': tf.get_variable('d4conv212w',[3,3,64,16],tf.float32,initializer),
    'd4conv221': tf.get_variable('d4conv221w',[1,1,878,64],tf.float32,initializer),
    'd4conv222': tf.get_variable('d4conv222w',[3,3,64,16],tf.float32,initializer),
    'd4conv231': tf.get_variable('d4conv231w',[1,1,894,64],tf.float32,initializer),
    'd4conv232': tf.get_variable('d4conv232w',[3,3,64,16],tf.float32,initializer),
    'd4conv241': tf.get_variable('d4conv241w',[1,1,910,64],tf.float32,initializer),
    'd4conv242': tf.get_variable('d4conv242w',[3,3,64,16],tf.float32,initializer),
    'd4conv251': tf.get_variable('d4conv251w',[1,1,926,64],tf.float32,initializer),
    'd4conv252': tf.get_variable('d4conv252w',[3,3,64,16],tf.float32,initializer),
    'd4conv261': tf.get_variable('d4conv261w',[1,1,942,64],tf.float32,initializer),
    'd4conv262': tf.get_variable('d4conv262w',[3,3,64,16],tf.float32,initializer),
    'd4conv271': tf.get_variable('d4conv271w',[1,1,958,64],tf.float32,initializer),
    'd4conv272': tf.get_variable('d4conv272w',[3,3,64,16],tf.float32,initializer),
    'd4conv281': tf.get_variable('d4conv281w',[1,1,974,64],tf.float32,initializer),
    'd4conv282': tf.get_variable('d4conv282w',[3,3,64,16],tf.float32,initializer),
    'd4conv291': tf.get_variable('d4conv291w',[1,1,990,64],tf.float32,initializer),
    'd4conv292': tf.get_variable('d4conv292w',[3,3,64,16],tf.float32,initializer),
    'd4conv301': tf.get_variable('d4conv301w',[1,1,1006,64],tf.float32,initializer),
    'd4conv302': tf.get_variable('d4conv302w',[3,3,64,16],tf.float32,initializer),
    'd4conv311': tf.get_variable('d4conv311w',[1,1,1022,64],tf.float32,initializer),
    'd4conv312': tf.get_variable('d4conv312w',[3,3,64,16],tf.float32,initializer),
    'd4conv321': tf.get_variable('d4conv321w',[1,1,1038,64],tf.float32,initializer),
    'd4conv322': tf.get_variable('d4conv322w',[3,3,64,16],tf.float32,initializer),
    'd4conv331': tf.get_variable('d4conv331w',[1,1,1054,64],tf.float32,initializer),
    'd4conv332': tf.get_variable('d4conv332w',[3,3,64,16],tf.float32,initializer),
    'd4conv341': tf.get_variable('d4conv341w',[1,1,1070,64],tf.float32,initializer),
    'd4conv342': tf.get_variable('d4conv342w',[3,3,64,16],tf.float32,initializer),
    'd4conv351': tf.get_variable('d4conv351w',[1,1,1086,64],tf.float32,initializer),
    'd4conv352': tf.get_variable('d4conv352w',[3,3,64,16],tf.float32,initializer),
    'd4conv361': tf.get_variable('d4conv361w',[1,1,1102,64],tf.float32,initializer),
    'd4conv362': tf.get_variable('d4conv362w',[3,3,64,16],tf.float32,initializer),
    'd4conv371': tf.get_variable('d4conv371w',[1,1,1118,64],tf.float32,initializer),
    'd4conv372': tf.get_variable('d4conv372w',[3,3,64,16],tf.float32,initializer),
    'd4conv381': tf.get_variable('d4conv381w',[1,1,1134,64],tf.float32,initializer),
    'd4conv382': tf.get_variable('d4conv382w',[3,3,64,16],tf.float32,initializer),
    'd4conv391': tf.get_variable('d4conv391w',[1,1,1150,64],tf.float32,initializer),
    'd4conv392': tf.get_variable('d4conv392w',[3,3,64,16],tf.float32,initializer),
    'd4conv401': tf.get_variable('d4conv401w',[1,1,1166,64],tf.float32,initializer),
    'd4conv402': tf.get_variable('d4conv402w',[3,3,64,16],tf.float32,initializer),
    'd4conv411': tf.get_variable('d4conv411w',[1,1,1182,64],tf.float32,initializer),
    'd4conv412': tf.get_variable('d4conv412w',[3,3,64,16],tf.float32,initializer),
    'd4conv421': tf.get_variable('d4conv421w',[1,1,1198,64],tf.float32,initializer),
    'd4conv422': tf.get_variable('d4conv422w',[3,3,64,16],tf.float32,initializer),

    'fc': tf.get_variable('fcw',[1214,10],tf.float32,initializer),
}
...
biases={
    ...
    'd3conv332': tf.get_variable('d3conv332b',[16],tf.float32,initializer),
    'd3conv341': tf.get_variable('d3conv341b',[64],tf.float32,initializer),
    'd3conv342': tf.get_variable('d3conv342b',[16],tf.float32,initializer),
    'd3conv351': tf.get_variable('d3conv351b',[64],tf.float32,initializer),
    'd3conv352': tf.get_variable('d3conv352b',[16],tf.float32,initializer),
    'd3conv361': tf.get_variable('d3conv361b',[64],tf.float32,initializer),
    'd3conv362': tf.get_variable('d3conv362b',[16],tf.float32,initializer),
    'd3conv371': tf.get_variable('d3conv371b',[64],tf.float32,initializer),
    'd3conv372': tf.get_variable('d3conv372b',[16],tf.float32,initializer),
    'd3conv381': tf.get_variable('d3conv381b',[64],tf.float32,initializer),
    'd3conv382': tf.get_variable('d3conv382b',[16],tf.float32,initializer),
    'd3conv391': tf.get_variable('d3conv391b',[64],tf.float32,initializer),
    'd3conv392': tf.get_variable('d3conv392b',[16],tf.float32,initializer),
    'd3conv401': tf.get_variable('d3conv401b',[64],tf.float32,initializer),
    'd3conv402': tf.get_variable('d3conv402b',[16],tf.float32,initializer),
    'd3conv411': tf.get_variable('d3conv411b',[64],tf.float32,initializer),
    'd3conv412': tf.get_variable('d3conv412b',[16],tf.float32,initializer),
    'd3conv421': tf.get_variable('d3conv421b',[64],tf.float32,initializer),
    'd3conv422': tf.get_variable('d3conv422b',[16],tf.float32,initializer),
    'd3conv431': tf.get_variable('d3conv431b',[64],tf.float32,initializer),
    'd3conv432': tf.get_variable('d3conv432b',[16],tf.float32,initializer),
    'd3conv441': tf.get_variable('d3conv441b',[64],tf.float32,initializer),
    'd3conv442': tf.get_variable('d3conv442b',[16],tf.float32,initializer),
    'd3conv451': tf.get_variable('d3conv451b',[64],tf.float32,initializer),
    'd3conv452': tf.get_variable('d3conv452b',[16],tf.float32,initializer),
    'd3conv461': tf.get_variable('d3conv461b',[64],tf.float32,initializer),
    'd3conv462': tf.get_variable('d3conv462b',[16],tf.float32,initializer),
    'd3conv471': tf.get_variable('d3conv471b',[64],tf.float32,initializer),
    'd3conv472': tf.get_variable('d3conv472b',[16],tf.float32,initializer),
    'd3conv481': tf.get_variable('d3conv481b',[64],tf.float32,initializer),
    'd3conv482': tf.get_variable('d3conv482b',[16],tf.float32,initializer),
    'd3conv491': tf.get_variable('d3conv491b',[64],tf.float32,initializer),
    'd3conv492': tf.get_variable('d3conv492b',[16],tf.float32,initializer),
    'd3conv501': tf.get_variable('d3conv501b',[64],tf.float32,initializer),
    'd3conv502': tf.get_variable('d3conv502b',[16],tf.float32,initializer),
    'd3conv511': tf.get_variable('d3conv511b',[64],tf.float32,initializer),
    'd3conv512': tf.get_variable('d3conv512b',[16],tf.float32,initializer),
    'd3conv521': tf.get_variable('d3conv521b',[64],tf.float32,initializer),
    'd3conv522': tf.get_variable('d3conv522b',[16],tf.float32,initializer),
    'd3conv531': tf.get_variable('d3conv531b',[64],tf.float32,initializer),
    'd3conv532': tf.get_variable('d3conv532b',[16],tf.float32,initializer),
    'd3conv541': tf.get_variable('d3conv541b',[64],tf.float32,initializer),
    'd3conv542': tf.get_variable('d3conv542b',[16],tf.float32,initializer),
    'd3conv551': tf.get_variable('d3conv551b',[64],tf.float32,initializer),
    'd3conv552': tf.get_variable('d3conv552b',[16],tf.float32,initializer),
    'd3conv561': tf.get_variable('d3conv561b',[64],tf.float32,initializer),
    'd3conv562': tf.get_variable('d3conv562b',[16],tf.float32,initializer),
    'd3conv571': tf.get_variable('d3conv571b',[64],tf.float32,initializer),
    'd3conv572': tf.get_variable('d3conv572b',[16],tf.float32,initializer),
    'd3conv581': tf.get_variable('d3conv581b',[64],tf.float32,initializer),
    'd3conv582': tf.get_variable('d3conv582b',[16],tf.float32,initializer),
    'd3conv591': tf.get_variable('d3conv591b',[64],tf.float32,initializer),
    'd3conv592': tf.get_variable('d3conv592b',[16],tf.float32,initializer),
    'd3conv601': tf.get_variable('d3conv601b',[64],tf.float32,initializer),
    'd3conv602': tf.get_variable('d3conv602b',[16],tf.float32,initializer),

    't3conv': tf.get_variable('t3conv',[542],tf.float32,initializer),
    ...
    'd4conv331': tf.get_variable('d4conv331b',[64],tf.float32,initializer),
    'd4conv332': tf.get_variable('d4conv332b',[16],tf.float32,initializer),
    'd4conv341': tf.get_variable('d4conv341b',[64],tf.float32,initializer),
    'd4conv342': tf.get_variable('d4conv342b',[16],tf.float32,initializer),
    'd4conv351': tf.get_variable('d4conv351b',[64],tf.float32,initializer),
    'd4conv352': tf.get_variable('d4conv352b',[16],tf.float32,initializer),
    'd4conv361': tf.get_variable('d4conv361b',[64],tf.float32,initializer),
    'd4conv362': tf.get_variable('d4conv362b',[16],tf.float32,initializer),
    'd4conv371': tf.get_variable('d4conv371b',[64],tf.float32,initializer),
    'd4conv372': tf.get_variable('d4conv372b',[16],tf.float32,initializer),
    'd4conv381': tf.get_variable('d4conv381b',[64],tf.float32,initializer),
    'd4conv382': tf.get_variable('d4conv382b',[16],tf.float32,initializer),
    'd4conv391': tf.get_variable('d4conv391b',[64],tf.float32,initializer),
    'd4conv392': tf.get_variable('d4conv392b',[16],tf.float32,initializer),
    'd4conv401': tf.get_variable('d4conv401b',[64],tf.float32,initializer),
    'd4conv402': tf.get_variable('d4conv402b',[16],tf.float32,initializer),
    'd4conv411': tf.get_variable('d4conv411b',[64],tf.float32,initializer),
    'd4conv412': tf.get_variable('d4conv412b',[16],tf.float32,initializer),
    'd4conv421': tf.get_variable('d4conv421b',[64],tf.float32,initializer),
    'd4conv422': tf.get_variable('d4conv422b',[16],tf.float32,initializer),
...
def classification(x,weightfc,biasfc):
    globalpool=tf.reshape(tf.nn.avg_pool(x,ksize=[1,4,4,1],strides=[1,1,1,1],padding='VALID'),[-1,1214])
...
def network(x):
    ...
    with tf.name_scope('DenseBlock3'):
        ...
        d3conv33=subblock(d3conv32,weights['d3conv331'],biases['d3conv331'],weights['d3conv332'],biases['d3conv332'])
        d3conv34=subblock(d3conv33,weights['d3conv341'],biases['d3conv341'],weights['d3conv342'],biases['d3conv342'])
        d3conv35=subblock(d3conv34,weights['d3conv351'],biases['d3conv351'],weights['d3conv352'],biases['d3conv352'])
        d3conv36=subblock(d3conv35,weights['d3conv361'],biases['d3conv361'],weights['d3conv362'],biases['d3conv362'])
        d3conv37=subblock(d3conv36,weights['d3conv371'],biases['d3conv371'],weights['d3conv372'],biases['d3conv372'])
        d3conv38=subblock(d3conv37,weights['d3conv381'],biases['d3conv381'],weights['d3conv382'],biases['d3conv382'])
        d3conv39=subblock(d3conv38,weights['d3conv391'],biases['d3conv391'],weights['d3conv392'],biases['d3conv392'])
        d3conv40=subblock(d3conv39,weights['d3conv401'],biases['d3conv401'],weights['d3conv402'],biases['d3conv402'])
        d3conv41=subblock(d3conv40,weights['d3conv411'],biases['d3conv411'],weights['d3conv412'],biases['d3conv412'])
        d3conv42=subblock(d3conv41,weights['d3conv421'],biases['d3conv421'],weights['d3conv422'],biases['d3conv422'])
        d3conv43=subblock(d3conv42,weights['d3conv431'],biases['d3conv431'],weights['d3conv432'],biases['d3conv432'])
        d3conv44=subblock(d3conv43,weights['d3conv441'],biases['d3conv441'],weights['d3conv442'],biases['d3conv442'])
        d3conv45=subblock(d3conv44,weights['d3conv451'],biases['d3conv451'],weights['d3conv452'],biases['d3conv452'])
        d3conv46=subblock(d3conv45,weights['d3conv461'],biases['d3conv461'],weights['d3conv462'],biases['d3conv462'])
        d3conv47=subblock(d3conv46,weights['d3conv471'],biases['d3conv471'],weights['d3conv472'],biases['d3conv472'])
        d3conv48=subblock(d3conv47,weights['d3conv481'],biases['d3conv481'],weights['d3conv482'],biases['d3conv482'])
        d3conv49=subblock(d3conv48,weights['d3conv491'],biases['d3conv491'],weights['d3conv492'],biases['d3conv492'])
        d3conv50=subblock(d3conv49,weights['d3conv501'],biases['d3conv501'],weights['d3conv502'],biases['d3conv502'])
        d3conv51=subblock(d3conv50,weights['d3conv511'],biases['d3conv511'],weights['d3conv512'],biases['d3conv512'])
        d3conv52=subblock(d3conv51,weights['d3conv521'],biases['d3conv521'],weights['d3conv522'],biases['d3conv522'])
        d3conv53=subblock(d3conv52,weights['d3conv531'],biases['d3conv531'],weights['d3conv532'],biases['d3conv532'])
        d3conv54=subblock(d3conv53,weights['d3conv541'],biases['d3conv541'],weights['d3conv542'],biases['d3conv542'])
        d3conv55=subblock(d3conv54,weights['d3conv551'],biases['d3conv551'],weights['d3conv552'],biases['d3conv552'])
        d3conv56=subblock(d3conv55,weights['d3conv561'],biases['d3conv561'],weights['d3conv562'],biases['d3conv562'])
        d3conv57=subblock(d3conv56,weights['d3conv571'],biases['d3conv571'],weights['d3conv572'],biases['d3conv572'])
        d3conv58=subblock(d3conv57,weights['d3conv581'],biases['d3conv581'],weights['d3conv582'],biases['d3conv582'])
        d3conv59=subblock(d3conv58,weights['d3conv591'],biases['d3conv591'],weights['d3conv592'],biases['d3conv592'])
        d3conv60=subblock(d3conv59,weights['d3conv601'],biases['d3conv601'],weights['d3conv602'],biases['d3conv602'])
    ...
    with tf.name_scope('DenseBlock4'):
        ...
        d4conv33=subblock(d4conv32,weights['d4conv331'],biases['d4conv331'],weights['d4conv332'],biases['d4conv332'])
        d4conv34=subblock(d4conv33,weights['d4conv341'],biases['d4conv341'],weights['d4conv342'],biases['d4conv342'])
        d4conv35=subblock(d4conv34,weights['d4conv351'],biases['d4conv351'],weights['d4conv352'],biases['d4conv352'])
        d4conv36=subblock(d4conv35,weights['d4conv361'],biases['d4conv361'],weights['d4conv362'],biases['d4conv362'])
        d4conv37=subblock(d4conv36,weights['d4conv371'],biases['d4conv371'],weights['d4conv372'],biases['d4conv372'])
        d4conv38=subblock(d4conv37,weights['d4conv381'],biases['d4conv381'],weights['d4conv382'],biases['d4conv382'])
        d4conv39=subblock(d4conv38,weights['d4conv391'],biases['d4conv391'],weights['d4conv392'],biases['d4conv392'])
        d4conv40=subblock(d4conv39,weights['d4conv401'],biases['d4conv401'],weights['d4conv402'],biases['d4conv402'])
        d4conv41=subblock(d4conv40,weights['d4conv411'],biases['d4conv411'],weights['d4conv412'],biases['d4conv412'])
        d4conv42=subblock(d4conv41,weights['d4conv421'],biases['d4conv421'],weights['d4conv422'],biases['d4conv422'])
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-250-16/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-250-26/var.ckpt',sess)
