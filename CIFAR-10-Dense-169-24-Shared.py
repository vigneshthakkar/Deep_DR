...
weights={
    ...
    'd333conv2': tf.get_variable('d3conv172w',[3,3,96,24],tf.float32,initializer),
...
biases={
    ...
    'd333conv2': tf.get_variable('d3conv172b',[24],tf.float32,initializer),
...
def network(x):
    ...
    with tf.name_scope('DenseBlock3'):
        ...
        d3conv17=subblock(d3conv16,weights['d3conv171'],biases['d3conv171'],weights['d333conv2'],biases['d333conv2'])
        d3conv18=subblock(d3conv17,weights['d3conv181'],biases['d3conv181'],weights['d333conv2'],biases['d333conv2'])
        d3conv19=subblock(d3conv18,weights['d3conv191'],biases['d3conv191'],weights['d333conv2'],biases['d333conv2'])
        d3conv20=subblock(d3conv19,weights['d3conv201'],biases['d3conv201'],weights['d333conv2'],biases['d333conv2'])
        d3conv21=subblock(d3conv20,weights['d3conv211'],biases['d3conv211'],weights['d333conv2'],biases['d333conv2'])
        d3conv22=subblock(d3conv21,weights['d3conv221'],biases['d3conv221'],weights['d333conv2'],biases['d333conv2'])
        d3conv23=subblock(d3conv22,weights['d3conv231'],biases['d3conv231'],weights['d333conv2'],biases['d333conv2'])
        d3conv24=subblock(d3conv23,weights['d3conv241'],biases['d3conv241'],weights['d333conv2'],biases['d333conv2'])
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-169-24-Shared/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-169-24-Shared/var.ckpt',sess)
