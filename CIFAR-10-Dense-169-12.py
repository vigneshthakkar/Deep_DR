...
weights={
    ...
    'd3conv251': tf.get_variable('d3conv251w',[1,1,381,48],tf.float32,initializer),
    'd3conv252': tf.get_variable('d3conv252w',[3,3,48,12],tf.float32,initializer),
    'd3conv261': tf.get_variable('d3conv261w',[1,1,393,48],tf.float32,initializer),
    'd3conv262': tf.get_variable('d3conv262w',[3,3,48,12],tf.float32,initializer),
    'd3conv271': tf.get_variable('d3conv271w',[1,1,405,48],tf.float32,initializer),
    'd3conv272': tf.get_variable('d3conv272w',[3,3,48,12],tf.float32,initializer),
    'd3conv281': tf.get_variable('d3conv281w',[1,1,417,48],tf.float32,initializer),
    'd3conv282': tf.get_variable('d3conv282w',[3,3,48,12],tf.float32,initializer),
    'd3conv291': tf.get_variable('d3conv291w',[1,1,429,48],tf.float32,initializer),
    'd3conv292': tf.get_variable('d3conv292w',[3,3,48,12],tf.float32,initializer),
    'd3conv301': tf.get_variable('d3conv301w',[1,1,441,48],tf.float32,initializer),
    'd3conv302': tf.get_variable('d3conv302w',[3,3,48,12],tf.float32,initializer),
    'd3conv311': tf.get_variable('d3conv311w',[1,1,453,48],tf.float32,initializer),
    'd3conv312': tf.get_variable('d3conv312w',[3,3,48,12],tf.float32,initializer),
    'd3conv321': tf.get_variable('d3conv321w',[1,1,465,48],tf.float32,initializer),
    'd3conv322': tf.get_variable('d3conv322w',[3,3,48,12],tf.float32,initializer),

    't3conv': tf.get_variable('t3convw',[1,1,477,239],tf.float32,initializer),

    'd4conv11': tf.get_variable('d4conv11w',[1,1,239,48],tf.float32,initializer),
    'd4conv12': tf.get_variable('d4conv12w',[3,3,48,12],tf.float32,initializer),
    'd4conv21': tf.get_variable('d4conv21w',[1,1,251,48],tf.float32,initializer),
    'd4conv22': tf.get_variable('d4conv22w',[3,3,48,12],tf.float32,initializer),
    'd4conv31': tf.get_variable('d4conv31w',[1,1,263,48],tf.float32,initializer),
    'd4conv32': tf.get_variable('d4conv32w',[3,3,48,12],tf.float32,initializer),
    'd4conv41': tf.get_variable('d4conv41w',[1,1,275,48],tf.float32,initializer),
    'd4conv42': tf.get_variable('d4conv42w',[3,3,48,12],tf.float32,initializer),
    'd4conv51': tf.get_variable('d4conv51w',[1,1,287,48],tf.float32,initializer),
    'd4conv52': tf.get_variable('d4conv52w',[3,3,48,12],tf.float32,initializer),
    'd4conv61': tf.get_variable('d4conv61w',[1,1,299,48],tf.float32,initializer),
    'd4conv62': tf.get_variable('d4conv62w',[3,3,48,12],tf.float32,initializer),
    'd4conv71': tf.get_variable('d4conv71w',[1,1,311,48],tf.float32,initializer),
    'd4conv72': tf.get_variable('d4conv72w',[3,3,48,12],tf.float32,initializer),
    'd4conv81': tf.get_variable('d4conv81w',[1,1,323,48],tf.float32,initializer),
    'd4conv82': tf.get_variable('d4conv82w',[3,3,48,12],tf.float32,initializer),
    'd4conv91': tf.get_variable('d4conv91w',[1,1,335,48],tf.float32,initializer),
    'd4conv92': tf.get_variable('d4conv92w',[3,3,48,12],tf.float32,initializer),
    'd4conv101': tf.get_variable('d4conv101w',[1,1,347,48],tf.float32,initializer),
    'd4conv102': tf.get_variable('d4conv102w',[3,3,48,12],tf.float32,initializer),
    'd4conv111': tf.get_variable('d4conv111w',[1,1,359,48],tf.float32,initializer),
    'd4conv112': tf.get_variable('d4conv112w',[3,3,48,12],tf.float32,initializer),
    'd4conv121': tf.get_variable('d4conv121w',[1,1,371,48],tf.float32,initializer),
    'd4conv122': tf.get_variable('d4conv122w',[3,3,48,12],tf.float32,initializer),
    'd4conv131': tf.get_variable('d4conv131w',[1,1,383,48],tf.float32,initializer),
    'd4conv132': tf.get_variable('d4conv132w',[3,3,48,12],tf.float32,initializer),
    'd4conv141': tf.get_variable('d4conv141w',[1,1,395,48],tf.float32,initializer),
    'd4conv142': tf.get_variable('d4conv142w',[3,3,48,12],tf.float32,initializer),
    'd4conv151': tf.get_variable('d4conv151w',[1,1,407,48],tf.float32,initializer),
    'd4conv152': tf.get_variable('d4conv152w',[3,3,48,12],tf.float32,initializer),
    'd4conv161': tf.get_variable('d4conv161w',[1,1,419,48],tf.float32,initializer),
    'd4conv162': tf.get_variable('d4conv162w',[3,3,48,12],tf.float32,initializer),
    'd4conv171': tf.get_variable('d4conv171w',[1,1,431,48],tf.float32,initializer),
    'd4conv172': tf.get_variable('d4conv172w',[3,3,48,12],tf.float32,initializer),
    'd4conv181': tf.get_variable('d4conv181w',[1,1,443,48],tf.float32,initializer),
    'd4conv182': tf.get_variable('d4conv182w',[3,3,48,12],tf.float32,initializer),
    'd4conv191': tf.get_variable('d4conv191w',[1,1,455,48],tf.float32,initializer),
    'd4conv192': tf.get_variable('d4conv192w',[3,3,48,12],tf.float32,initializer),
    'd4conv201': tf.get_variable('d4conv201w',[1,1,467,48],tf.float32,initializer),
    'd4conv202': tf.get_variable('d4conv202w',[3,3,48,12],tf.float32,initializer),
    'd4conv211': tf.get_variable('d4conv211w',[1,1,479,48],tf.float32,initializer),
    'd4conv212': tf.get_variable('d4conv212w',[3,3,48,12],tf.float32,initializer),
    'd4conv221': tf.get_variable('d4conv221w',[1,1,491,48],tf.float32,initializer),
    'd4conv222': tf.get_variable('d4conv222w',[3,3,48,12],tf.float32,initializer),
    'd4conv231': tf.get_variable('d4conv231w',[1,1,503,48],tf.float32,initializer),
    'd4conv232': tf.get_variable('d4conv232w',[3,3,48,12],tf.float32,initializer),
    'd4conv241': tf.get_variable('d4conv241w',[1,1,515,48],tf.float32,initializer),
    'd4conv242': tf.get_variable('d4conv242w',[3,3,48,12],tf.float32,initializer),
    'd4conv251': tf.get_variable('d4conv251w',[1,1,527,48],tf.float32,initializer),
    'd4conv252': tf.get_variable('d4conv252w',[3,3,48,12],tf.float32,initializer),
    'd4conv261': tf.get_variable('d4conv261w',[1,1,539,48],tf.float32,initializer),
    'd4conv262': tf.get_variable('d4conv262w',[3,3,48,12],tf.float32,initializer),
    'd4conv271': tf.get_variable('d4conv271w',[1,1,551,48],tf.float32,initializer),
    'd4conv272': tf.get_variable('d4conv272w',[3,3,48,12],tf.float32,initializer),
    'd4conv281': tf.get_variable('d4conv281w',[1,1,563,48],tf.float32,initializer),
    'd4conv282': tf.get_variable('d4conv282w',[3,3,48,12],tf.float32,initializer),
    'd4conv291': tf.get_variable('d4conv291w',[1,1,575,48],tf.float32,initializer),
    'd4conv292': tf.get_variable('d4conv292w',[3,3,48,12],tf.float32,initializer),
    'd4conv301': tf.get_variable('d4conv301w',[1,1,587,48],tf.float32,initializer),
    'd4conv302': tf.get_variable('d4conv302w',[3,3,48,12],tf.float32,initializer),
    'd4conv311': tf.get_variable('d4conv311w',[1,1,599,48],tf.float32,initializer),
    'd4conv312': tf.get_variable('d4conv312w',[3,3,48,12],tf.float32,initializer),
    'd4conv321': tf.get_variable('d4conv321w',[1,1,611,48],tf.float32,initializer),
    'd4conv322': tf.get_variable('d4conv322w',[3,3,48,12],tf.float32,initializer),

    'fc': tf.get_variable('fcw',[623,10],tf.float32,initializer),
}
...
biases={
    ...
    'd3conv251': tf.get_variable('d3conv251b',[48],tf.float32,initializer),
    'd3conv252': tf.get_variable('d3conv252b',[12],tf.float32,initializer),
    'd3conv261': tf.get_variable('d3conv261b',[48],tf.float32,initializer),
    'd3conv262': tf.get_variable('d3conv262b',[12],tf.float32,initializer),
    'd3conv271': tf.get_variable('d3conv271b',[48],tf.float32,initializer),
    'd3conv272': tf.get_variable('d3conv272b',[12],tf.float32,initializer),
    'd3conv281': tf.get_variable('d3conv281b',[48],tf.float32,initializer),
    'd3conv282': tf.get_variable('d3conv282b',[12],tf.float32,initializer),
    'd3conv291': tf.get_variable('d3conv291b',[48],tf.float32,initializer),
    'd3conv292': tf.get_variable('d3conv292b',[12],tf.float32,initializer),
    'd3conv301': tf.get_variable('d3conv301b',[48],tf.float32,initializer),
    'd3conv302': tf.get_variable('d3conv302b',[12],tf.float32,initializer),
    'd3conv311': tf.get_variable('d3conv311b',[48],tf.float32,initializer),
    'd3conv312': tf.get_variable('d3conv312b',[12],tf.float32,initializer),
    'd3conv321': tf.get_variable('d3conv321b',[48],tf.float32,initializer),
    'd3conv322': tf.get_variable('d3conv322b',[12],tf.float32,initializer),

    't3conv': tf.get_variable('t3conv',[239],tf.float32,initializer),
    ...
    'd4conv171': tf.get_variable('d4conv171b',[48],tf.float32,initializer),
    'd4conv172': tf.get_variable('d4conv172b',[12],tf.float32,initializer),
    'd4conv181': tf.get_variable('d4conv181b',[48],tf.float32,initializer),
    'd4conv182': tf.get_variable('d4conv182b',[12],tf.float32,initializer),
    'd4conv191': tf.get_variable('d4conv191b',[48],tf.float32,initializer),
    'd4conv192': tf.get_variable('d4conv192b',[12],tf.float32,initializer),
    'd4conv201': tf.get_variable('d4conv201b',[48],tf.float32,initializer),
    'd4conv202': tf.get_variable('d4conv202b',[12],tf.float32,initializer),
    'd4conv211': tf.get_variable('d4conv211b',[48],tf.float32,initializer),
    'd4conv212': tf.get_variable('d4conv212b',[12],tf.float32,initializer),
    'd4conv221': tf.get_variable('d4conv221b',[48],tf.float32,initializer),
    'd4conv222': tf.get_variable('d4conv222b',[12],tf.float32,initializer),
    'd4conv231': tf.get_variable('d4conv231b',[48],tf.float32,initializer),
    'd4conv232': tf.get_variable('d4conv232b',[12],tf.float32,initializer),
    'd4conv241': tf.get_variable('d4conv241b',[48],tf.float32,initializer),
    'd4conv242': tf.get_variable('d4conv242b',[12],tf.float32,initializer),
    'd4conv251': tf.get_variable('d4conv251b',[48],tf.float32,initializer),
    'd4conv252': tf.get_variable('d4conv252b',[12],tf.float32,initializer),
    'd4conv261': tf.get_variable('d4conv261b',[48],tf.float32,initializer),
    'd4conv262': tf.get_variable('d4conv262b',[12],tf.float32,initializer),
    'd4conv271': tf.get_variable('d4conv271b',[48],tf.float32,initializer),
    'd4conv272': tf.get_variable('d4conv272b',[12],tf.float32,initializer),
    'd4conv281': tf.get_variable('d4conv281b',[48],tf.float32,initializer),
    'd4conv282': tf.get_variable('d4conv282b',[12],tf.float32,initializer),
    'd4conv291': tf.get_variable('d4conv291b',[48],tf.float32,initializer),
    'd4conv292': tf.get_variable('d4conv292b',[12],tf.float32,initializer),
    'd4conv301': tf.get_variable('d4conv301b',[48],tf.float32,initializer),
    'd4conv302': tf.get_variable('d4conv302b',[12],tf.float32,initializer),
    'd4conv311': tf.get_variable('d4conv311b',[48],tf.float32,initializer),
    'd4conv312': tf.get_variable('d4conv312b',[12],tf.float32,initializer),
    'd4conv321': tf.get_variable('d4conv321b',[48],tf.float32,initializer),
    'd4conv322': tf.get_variable('d4conv322b',[12],tf.float32,initializer),
...
def classification(x,weightfc,biasfc):
    globalpool=tf.reshape(tf.nn.avg_pool(x,ksize=[1,4,4,1],strides=[1,1,1,1],padding='VALID'),[-1,623])
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-169-12/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-169-12/var.ckpt',sess)
