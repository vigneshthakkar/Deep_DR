...
weights={
    ...
    'd333conv2': tf.get_variable('d3conv312w',[3,3,64,16],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv222w',[3,3,64,16],tf.float32,initializer),
...
biases={
    ...
    'd333conv2': tf.get_variable('d3conv312b',[16],tf.float32,initializer),
    ...
    'd433conv2': tf.get_variable('d4conv222b',[16],tf.float32,initializer),
...
def restore(sess):
    saver=tf.train.Saver()
    saver.restore(sess,tf.train.latest_checkpoint('./Dense-250-16-Shared/'))
...
def train():
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(1,101):
            ...
            if epoch%2==0: save('Dense-250-16-Shared/var.ckpt',sess)
